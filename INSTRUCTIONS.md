...
<img src="https://33uee5uclf.ufs.sh/f/fa600f97-6cf2-4759-8641-3093d13591bf-6rrk6b.png" alt="Voxelo" width="720" />
...
[![Watch on YouTube](https://img.shields.io/badge/Watch_the_Full_Course-FF0000?style=for-the-badge&logo=youtube&logoColor=white)](https://cwa.run/voxelo-gh-yt)
...
```bash
git clone https://github.com/code-with-antonio/voxelo.git
cd voxelo
npm install
```
...
Voxelo is designed to be self-hosted. You'll need:
